...
#files_gradient_enhanced_rankine = {'./gradient_enhanced_rankine/rankine_epsf=8e-3_ldam=2.csv' : r'ge rankine: $\epsilon_f=\num{8e-3}, l=\SI{2}{mm}$',
#                                   './gradient_enhanced_rankine/rankine_epsf=4e-3_ldam=4.csv' : r'ge rankine: $\epsilon_f=\num{4e-3}, l=\SI{4}{mm}$',}
colors_rankine = plt.cm.Blues_r(np.linspace(0.0, 0.8, len(files_gradient_enhanced_rankine) ))
...
#files_efem = {'./embedded_fem/efem_fine.csv' : r'efem-fine (Matthias mesh)',}
colors_efem = plt.cm.Reds_r(np.linspace(0., 0.8, len(files_efem) ))
...
files_phase_field = {'./phase_field/fd_fine_linear.csv' : r'phase field: $l=\SI{7.5}{mm}$'}
